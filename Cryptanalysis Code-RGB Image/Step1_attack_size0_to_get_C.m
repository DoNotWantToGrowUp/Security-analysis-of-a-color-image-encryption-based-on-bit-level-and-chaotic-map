...
clear;clc;close all;
tic
%% Construct zero pixel value image
B=zeros(2,2,3);
% B=zeros(4,4,3);
% B=zeros(256,256,3);
% B=zeros(320,512,3);
...
%% Decoding article object algorithm encrypts zero pixel image
...
toc
%% output
% imwrite(uint8(B),'./images/all0_size2.png');
% imwrite(uint8(C),'./images/all0_cipher_size2.png');
% imwrite(uint8(B),'./images/all0_size4.bmp');
% imwrite(uint8(C),'./images/all0_cipher_size4.png');
% imwrite(uint8(B),'./images/all0_size256.png');
% imwrite(uint8(C),'./images/all0_cipher_size256.png');
