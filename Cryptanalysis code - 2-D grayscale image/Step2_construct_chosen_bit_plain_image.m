...
%Constructing some special general images
clear;clc;close all;
tic
%% Construct some special ordinary images with incrementing pixel values starting from 0
% W=2;H=2;
% W=4;H=4;
W=256;H=256;
% W=512;H=320;
...
%% Image pixel values are decomposed into the corresponding binary matrix by high and low bits
cp1=bitand(cp,1);
cp2=bitand(cp,2)/2;
...
%% Convert a 1D matrix of bit level into a 2D image of size H*W*3
