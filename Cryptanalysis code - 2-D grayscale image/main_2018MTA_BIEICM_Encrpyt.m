% Programe description：2018-MTA-Korean-BIE-ICM encryption
...
imwrite(uint8(B),'./images/size2_2.png');


figure(1);
B=uint8(B);
C=uint8(C_H_3W);
subplot(1,2,1);imshow(B);title('明文');
...
suptitle('明文转换成bit平面与密文转换成bit平面对比');
