...
%size 2*2
% bit_q=bit_P_q1+bit_P_q2*2+bit_P_q3*2^2+bit_P_q4*2^3+bit_P_q5*2^4;
%size 2*2*3
...
%size 256*256
bit_q=bit_P_q1+bit_P_q2*2+bit_P_q3*2^2+bit_P_q4*2^3+bit_P_q5*2^4+bit_P_q6*2^5+bit_P_q7*2^6+bit_P_q8*2^7+bit_P_q9*2^8+bit_P_q10*2^9+bit_P_q11*2^10 ...
    +bit_P_q12*2^11+bit_P_q13*2^12+bit_P_q14*2^13+bit_P_q15*2^14+bit_P_q16*2^15+bit_P_q17*2^16+bit_P_q18*2^17+bit_P_q19*2^18;
...
[H,W0]=size(Q_Lena_P);W=W0;len=H*W*8;
